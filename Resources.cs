...
public class Resources
{
    ...
    // public static readonly Shape[] GiftShapes = { Shape.FromImage(GiftImages[0]), Shape.FromImage(GiftImages[1])
    //     , Shape.FromImage(GiftImages[2]), Shape.FromImage(GiftImages[3]), Shape.FromImage(GiftImages[4]) };
